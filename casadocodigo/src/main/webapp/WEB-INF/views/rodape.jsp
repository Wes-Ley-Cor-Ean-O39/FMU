	...
	<div id="newsletter-footer">
		...
		<ul class="footer-payments">
			<li class="rodape-formaDePagamento">
				<img src="//cdn.shopify.com/s/files/1/0155/7645/t/232/assets/pagseguro.png?104" border="0" alt="pag seguro"/>
			</li>
			<li class="rodape-formaDePagamento">
				<img src="//cdn.shopify.com/s/files/1/0155/7645/t/232/assets/paypal.png?104" border="0" alt="paypal"/>
			</li>
		</ul>
	</div>
  </div>
