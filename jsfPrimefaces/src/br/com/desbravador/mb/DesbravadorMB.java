...
import br.com.desbravador.dao.DesbravadorDao;
...
public class DesbravadorMB {
	...
	private static final Logger LOGGER = LogManager.getLogger(DesbravadorMB.class.getName());
	...
	public void excluirFromGrid(ActionEvent event) {
		LOGGER.info("entrei no botao gerar");
		// FacesContext ctx = FacesContext.getCurrentInstance();
	}
