...
import br.com.desbravador.dao.AlunoDao;
import br.com.desbravador.entity.Aluno;
import br.com.desbravador.entity.Escola;
import br.com.desbravador.entity.Nota;
import br.com.desbravador.entity.Salaaula;
...
public class AlunoMB {
	...
	public void excluirAluno(ActionEvent actionEvent) {
		...
		addMessage("Aluno Exclu�do com Sucesso!");
	}
	...
	public static void excluirNotaList(ActionEvent actionEvent) {
		...
		listNotas = AlunoDao.buscaNotasByIdAluno(aluno.getId());
		addMessage("Nota (s) Exclu�da com Sucesso!");
	}
	...
	public void excluirFromGridNota(ActionEvent event) {
		...
		consultarAllAluno();
		addMessage("Aluno(s) Exclu�do(s) com Sucesso!");
	}
	...
	public void consultarAllAluno() {
		...
		// INSIRA AQUI O MET�DO DE CONSULTA DE ESCOLA E SALA DE AULA FEITOS NO DAO!!!
	}
	...
	public void buscaCep(AjaxBehaviorEvent event) {
		...
		try {
			doc = Jsoup.connect(
					"http://www.qualocep.com/busca-cep/" + aluno.getCep().replaceAll("-", ""))
					.get();
